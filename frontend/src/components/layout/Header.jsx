            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
              ...
              {isAuthenticated && onHistoryClick && (
                <button
                  ...
                  style={{ ...navBtnBase, background: "transparent", border: "1px solid rgba(200,165,90,0.25)" }}
              ...
              {isAuthenticated ? (
                <>
                  ...
                  {(user?.role === "admin" || user?.role === "elder") && (
                    <Link
                      ...
                      title="Dashboard"
                      style={navBtnBase}
                      onMouseEnter={e => { e.currentTarget.style.background = "rgba(200,165,90,0.18)"; e.currentTarget.style.borderColor = "rgba(200,165,90,0.35)"; }}
                  ...
                  <button
                    ...
                    onMouseEnter={e => e.currentTarget.style.background = "rgba(200,50,40,0.85)"}
                    onMouseLeave={e => e.currentTarget.style.background = "rgba(180,40,30,0.70)"}
                  >
                ...
                <Link
                  ...
                  onMouseEnter={e => e.currentTarget.style.background = "rgba(154,111,42,0.95)"}
                  onMouseLeave={e => e.currentTarget.style.background = "rgba(154,111,42,0.75)"}
                >
        ...
        >
          <div style={{
            ...
            <div style={{
              ...
              <svg style={{ width: "28px", height: "28px", color: "#b45309" }} fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
            </div>
            <h3 style={{ fontSize: "1.2rem", fontWeight: "700", color: "#1c1409", marginBottom: "0.5rem", fontFamily: "system-ui, sans-serif" }}>
              Confirm Logout
            </h3>
            <p style={{ color: "#6b7280", fontSize: "0.95rem", marginBottom: "2rem", fontFamily: "system-ui, sans-serif" }}>
