...
import { BrowserSpeechRecognition, isSpeechRecognitionSupported } from '../../utils/browserSTT';
        ...
        if (shouldRetry && errorType === 'network' && language !== 'english') {
          ...
          setTimeout(() => {
            try {
              ...
              setError('Speech recognition unavailable. Please check your internet connection.');
              if (onError) {
    ...
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        className={`
          ...
          ${disabled || isProcessing || !isSpeechRecognitionSupported() ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'}
