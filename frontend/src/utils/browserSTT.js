...
export class BrowserSpeechRecognition {
  ...
  initialize(language = 'english') {
    ...
    this.recognition.onstart = () => {
      ...
      console.log(`Speech recognition started for ${language} (${this.recognition.lang})`);
...
export const getSupportedSpeechLanguages = () => {
  return [
    'english', 'sinhala', 'tamil', 'hindi', 'chinese', 'japanese', 
    'korean', 'french', 'german', 'spanish', 'italian', 'portuguese', 
    'russian', 'arabic', 'dutch', 'thai', 'vietnamese', 'turkish'
  ];
};